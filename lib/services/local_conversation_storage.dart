...
class LocalConversationStorage {
  ...
  Future<void> saveConversation(Map<String, dynamic> conversation) async {
    ...
    try {
      ...
      throw Exception('Failed to save conversation $conversationId: $e');
    }
  }
  ...
  Future<Conversation?> loadConversation(String conversationId) async {
    ...
    try {
      ...
      throw Exception('Failed to load conversation $conversationId: $e');
    }
  }
  ...
  Future<bool> deleteConversation(String conversationId) async {
    ...
    try {
      ...
      throw Exception('Failed to delete conversation $conversationId: $e');
    }
  }
